            ...
            <section className="section" id="about">
                ...
                <div className="section-content">
                    ...
                    <ul>
                        ...
                        <li>Management and orchestration of K0s, K3s, Microk8s and K8s clusters (1 master 2 workers)
                        </li>
                ...
                <div className="section-content">
                    ...
                    <ul>
                        ...
                        <li>Management and orchestration of K3s, Microk8s, and K8s clusters and 1 Raspberry Pi 3
                            together with 4 Raspberry Pi 0 with the topology (1 master 3/4 workers)
                        </li>
                        <li>Conducting a set of tests to determine what can be done with management and orchestration
                            tools
                        </li>
                        <li>Preparation of final presentation of results</li>
